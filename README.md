...
<h3 align="center">Full Stack Developer | AI & Deep Learning Researcher | System Design Enthusiast</h3>

<p align="center">
  <a href="https://github.com/srikar0805?tab=repositories&sort=stargazers"><img alt="total stars" src="https://img.shields.io/github/stars/srikar0805?color=0e75b6&labelColor=333&style=flat-square" /></a>
  <a href="https://github.com/srikar0805?tab=followers"><img alt="followers" src="https://img.shields.io/github/followers/srikar0805?color=0e75b6&labelColor=333&style=flat-square" /></a>
</p>

---

### 🚀 About Me
I am a passionate developer bridging the gap between **Complex System Architecture** and **Advanced AI Solutions**. I enjoy building scalable full-stack applications and exploring the depths of Computer Vision and Quantum Computing.

- 🔭 **Currently working on:**
  - **Quantum Image Vision**: Exploring quantum algorithms for image processing.
  - **Automated Monitoring Systems**: Developing livestock classification systems using Computer Vision (OAK/RealSense).
  - **Ticketmaster Clone**: Building high-concurrency booking systems with Node.js, Redis, and Kafka.
  - **Satellite Imagery Analysis**: Applying Neural Networks to geospatial data (DeepGlobe, EuroSAT).

- 🌱 **Currently learning:** Advanced Distributed Systems, Quantum Computing.

- 👯 **Looking to collaborate on:** Open Source AI projects, ML Research, and Scalable Web Systems.
